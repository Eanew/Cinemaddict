...
class AbstractComponent {
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(this.getTemplate());
    }
  ...
  show() {
    if (this._element) {
      this._element.classList.remove(_utils_const_js__WEBPACK_IMPORTED_MODULE_0__["HIDDEN_CLASS"]);
    }
  }

  hide() {
    if (this._element) {
      this._element.classList.add(_utils_const_js__WEBPACK_IMPORTED_MODULE_0__["HIDDEN_CLASS"]);
    }
  }
}
...
/*!************************************!*\
  !*** ./src/components/comments.js ***!
  \************************************/
/*! exports provided: default, DeleteButtonText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentsComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeleteButtonText", function() { return DeleteButtonText; });
...
/* harmony import */ var _utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/data-process.js */ "./src/utils/data-process.js");
...
const renderCommentsItemMarkup = ({author, comment, date, emotion}) => {
  const time = moment__WEBPACK_IMPORTED_MODULE_4___default()(date).calendar(null, {
    sameDay: `[${moment__WEBPACK_IMPORTED_MODULE_4___default()(date).fromNow()}]`,
...
const createCommentsTemplate = (comments) => {
  const detailsCommentsMarkup = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["createMarkup"])(comments, renderCommentsItemMarkup);
  const emojiListMarkup = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["createMarkup"])(EMOJI_LIST, renderEmojiItemMarkup);
...
class CommentsComponent extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getLocalComment() {
    return Object.assign({}, this._localComment, {
      'comment': this._localComment[`comment`] ? Object(he__WEBPACK_IMPORTED_MODULE_3__["encode"])(this._localComment[`comment`]) : null,
  ...
  onCommentSubmit(handler) {
    this.getElement().querySelector(`.film-details__new-comment`)
      .addEventListener(`keydown`, (evt) => {
        if (evt.key === _utils_common_js__WEBPACK_IMPORTED_MODULE_2__["Key"].ENTER && !evt.shiftKey) {
          evt.preventDefault();
          handler();
        }
      });
...
/*!***********************************!*\
  !*** ./src/components/details.js ***!
  \***********************************/
/*! exports provided: createDetailsTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DetailsComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
/* harmony import */ var _utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/data-process.js */ "./src/utils/data-process.js");
...
const getReleaseDate = (iso) => {
  ...
  const day = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["setTwoDigit"])(date, Date.prototype.getDate);
...
const parsePopupData = (card) => {
  ...
  const activeButtons = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["setActiveItems"])([watchlistButtonStatus, watchedButtonStatus, favoriteButtonStatus]);
  const tableValues = [
    [info[`director`]],
    info[`writers`],
    info[`actors`],
    [getReleaseDate(info[`release`][`date`])],
    [Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(info[`runtime`])],
  ...
  return {
    ...
    detailsControlsMarkup: Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["createMarkup"])(CONTROL_BUTTONS_LIST, renderControlFieldMarkup, ...activeButtons),
    detailsTableMarkup: Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_1__["createMarkup"])(tableFields, renderFilmDetailsRowMarkup),
  };
};
...
class DetailsComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card) {
    super();
...
/* harmony import */ var _utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/data-process.js */ "./src/utils/data-process.js");
...
const renderControlButtonMarkup = (button, isActive = false) => {
  ...
  return (
    `<button class="film-card__controls-item button film-card__controls-item--${id || Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["setId"])(name)}
...
const getDescription = (string) => string.length > MAX_DESCRIPTION_LENGTH
  ? string.replace(string.slice(MAX_DESCRIPTION_LENGTH), _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["Regular"].ELLIPSIS)
  : string;
...
const parseFilmCardData = (card) => {
  ...
  const duration = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["getDuration"])(info[`runtime`]);
  const genre = info[`genre`][0];
  const watchlistButtonStatus = card[`user_details`][`watchlist`];
  const watchedButtonStatus = card[`user_details`][`already_watched`];
  const favoriteButtonStatus = card[`user_details`][`favorite`];
  const activeButtons = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["setActiveItems"])([watchlistButtonStatus, watchedButtonStatus, favoriteButtonStatus]);
  ...
  return {
    ...
    buttonsMarkup: Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["createMarkup"])(CONTROL_BUTTONS_LIST, renderControlButtonMarkup, ...activeButtons),
    infoFieldsMarkup: Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["createMarkup"])(infoFields, renderInfoFieldMarkup),
  };
};
...
class CardComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card) {
    super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmListTitleComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class FilmListTitleComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmListComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class FilmListComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmsContainerComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class FilmsContainerComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createFilterTemplate = (filters) => {
  const filterItemsMarkup = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["createMarkup"])(filters, createFilterItemMarkup);
...
const getFilterType = (element) => Object.values(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"])
...
class FilterComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  resetFilter() {
    ...
    Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["swapActiveElements"])(this.getElement(), defaultFilterButton, ACTIVE_FILTER_CLASS);
  }
  ...
  setFilterChangeHandler(handler) {
    this.getElement().querySelector(`.main-navigation__items`)
      .addEventListener(`click`, (evt) => {
        ...
        Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["swapActiveElements"])(this.getElement(), evt.target, ACTIVE_FILTER_CLASS);
        handler(filterType);
      });
  }
...
/***/ "./src/components/footer-statistics.js":
/*!*********************************************!*\
  !*** ./src/components/footer-statistics.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FooterStatisticsComponent; });
...
class FooterStatisticsComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    super();
...
class LoadMoreButtonComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class LoadingComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoMoviesComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class NoMoviesComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SortingComponent; });
...
const createSortingTemplate = (currentSortType) => {
  const activeElements = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["matchActiveItems"])(currentSortType, SORT_TYPES_LIST);
  const sortItemsMarkup = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["createMarkup"])(SORT_TYPES_LIST, createSortingItemMarkup, ...activeElements);
...
class SortingComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  ...
  resetSortType() {
    ...
    this._currentSortType = SortType.DEFAULT;
    Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["swapActiveElements"])(this.getElement(), defaultSortingButton, ACTIVE_BUTTON_CLASS);
  }
  ...
  onSortTypeChange(handler) {
    this.getElement().addEventListener(`click`, (evt) => {
      ...
      Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["swapActiveElements"])(this.getElement(), evt.target, ACTIVE_BUTTON_CLASS);
...
const renderIntervalFieldMarkup = (name, isChecked = false) => {
  const id = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["setId"])(name);
...
const formatStatisticString = (text) => {
  return text.split(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["Regular"].SPACE)

    .map((it) => (it.length && it.toLowerCase().replace(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["Regular"].NUMBERS, ``) === it)
      ? `<span class="statistic__item-description">${it}</span>`
      : it)

    .join(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["Regular"].SPACE);
};
...
const createStatisticTemplate = (userInfo, statisticFields, isShowed, currentInterval) => {
  ...
  const intervals = Object.values(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticInterval"]);
  const activeItems = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["matchActiveItems"])(currentInterval, intervals);

  const rankMarkup = createStatisticRankMarkup(avatar, rank);
  const intervalFieldsMarkup = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["createMarkup"])(intervals, renderIntervalFieldMarkup, ...activeItems);
  const statisticFieldsMarkup = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["createMarkup"])(statisticFields, renderStatisticFieldMarkup);

  return (
    `<section class="statistic${!isShowed ? ` ${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]}` : ``}">
      ${rankMarkup}
...
class StatisticComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  onIntervalChange(handler) {
    this.getElement().querySelector(`.statistic__filters`)
      .addEventListener(`change`, (evt) => {
        ...
        const interval = Object.values(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticInterval"]).find((it) => Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_2__["setId"])(it) === evt.target.value);
        handler(interval);
      });
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UserLevelComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class UserLevelComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _utils_data_process_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/data-process.js */ "./src/utils/data-process.js");
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../main.js */ "./src/main.js");
/* harmony import */ var _components_filter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/filter.js */ "./src/components/filter.js");
...
class FilterController {
  constructor(container, moviesModel) {
    ...
    this._activeFilterType = _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL_MOVIES;
  ...
  reset() {
    this._onFilterChange(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL_MOVIES);
  ...
  render() {
    ...
    const filters = Object.values(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"]).map((filterType) => ({
      name: filterType,
      id: filterType === _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL_MOVIES ? ALL_MOVIES_ID : Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_3__["setId"])(filterType),
      count: filterType === _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL_MOVIES ? null : Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["getCardsByFilter"])(allCards, filterType).length,
      checked: filterType === this._activeFilterType,
    }));

    const oldComponent = this._filterComponent;
    this._filterComponent = new _components_filter_js__WEBPACK_IMPORTED_MODULE_5__["default"](filters);
    this._filterComponent.setFilterChangeHandler(this._onFilterChange);
    this._filterComponent.setStatisticButtonClickHandler(_main_js__WEBPACK_IMPORTED_MODULE_4__["statisticDisplayToggle"]);

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._filterComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
    }
  }
...
/* harmony import */ var _components_details_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/details.js */ "./src/components/details.js");
/* harmony import */ var _components_comments_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/comments.js */ "./src/components/comments.js");
...
class MovieController {
  ...
  render(card) {
    ...
    this._cardComponent = new _components_film_card_js__WEBPACK_IMPORTED_MODULE_2__["default"](card);
    this._detailsComponent = new _components_details_js__WEBPACK_IMPORTED_MODULE_3__["default"](card);
    this._commentsComponent = new _components_comments_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._comments);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._commentsContainer, this._commentsComponent);

    if (oldCardComponent && oldDetailsComponent) {

      if (pageBody.contains(oldDetailsComponent.getElement())) {
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._detailsComponent, oldDetailsComponent);
        this._addPopupListeners();
      }

      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._cardComponent, oldCardComponent);
      return;
    }
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._cardComponent);
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._cardComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._detailsComponent);
  ...
  _onPopupEscPress(evt) {
    Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["isEscEvent"])(evt, this._closePopup);
  }
  ...
  _onCommentsListClick(evt) {
    Array.from(evt.currentTarget.children).forEach((item, index) => {
      ...
      if (item.contains(evt.target)) {
        evt.target.textContent = _components_comments_js__WEBPACK_IMPORTED_MODULE_4__["DeleteButtonText"].DELETING;
        ...
        this._api.deleteComment(this._comments[index][`id`])
          ...
          .catch(() => {
            this._shake();
            evt.target.textContent = _components_comments_js__WEBPACK_IMPORTED_MODULE_4__["DeleteButtonText"].DEFAULT;
...
/* harmony import */ var _components_no_movies_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-movies.js */ "./src/components/no-movies.js");
/* harmony import */ var _components_film_list_title_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/film-list-title.js */ "./src/components/film-list-title.js");
/* harmony import */ var _components_films_container_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/films-container.js */ "./src/components/films-container.js");
...
/* harmony import */ var _movie_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./movie-controller */ "./src/controllers/movie-controller.js");
...
const renderCards = (filmsContainerElement, cards, onDataChange, onViewChange, api) => {
  return cards.map((card) => {
    const movieController = new _movie_controller__WEBPACK_IMPORTED_MODULE_6__["default"](filmsContainerElement, onDataChange, onViewChange, api);
...
const getSortedCards = (cards, sortType, from, to) => {
  ...
  switch (sortType) {
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT:
      sortedCadrs = showingCards;
      break;

    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE:
      sortedCadrs = sortByDate(showingCards);
      break;

    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RAITING:
...
class PageController {
  constructor(container, moviesModel, api) {
    ...
    this._noMoviesComponent = new _components_no_movies_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._filmListTitleComponent = new _components_film_list_title_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._filmsContainerComponent = new _components_films_container_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._loadMoreButtonComponent = new _components_load_more_button_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  ...
  render() {
    if (!this._moviesModel.getMovies() || !this._moviesModel.getMovies().length) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sectionContainerElement, this._noMoviesComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sectionContainerElement, this._sortingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sectionContainerElement, this._filmListTitleComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sectionContainerElement, this._filmsContainerComponent);
    this._renderCards(0, this._currentFilmsCount);
    this._renderLoadMoreButton();
  }

  _renderLoadMoreButton() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._loadMoreButtonComponent);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filmsContainerElement, this._loadMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND);
  }
...
/* harmony import */ var _utils_statistic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/statistic.js */ "./src/utils/statistic.js");
/* harmony import */ var _utils_data_process_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/data-process.js */ "./src/utils/data-process.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
/* harmony import */ var _components_user_level_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/user-level.js */ "./src/components/user-level.js");
/* harmony import */ var _components_statistic_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/statistic.js */ "./src/components/statistic.js");
...
/* harmony import */ var chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! chartjs-plugin-datalabels */ "./node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.js");
/* harmony import */ var chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_9__);
...
const createChart = (ctx, genres) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_8___default.a(ctx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_9___default.a],
    type: `horizontalBar`,
    data: {
...
const generateStatisticFields = (textFieldValues) => Object.values(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticField"]).map((it, i) => ({
  name: (it === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticField"].GENRES && textFieldValues[i].indexOf(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["Regular"].COMMA) !== -1) ? `${it}s` : it,
...
const getStatisticFields = (cards, genres) => {
  ...
  const durationString = Object(_utils_data_process_js__WEBPACK_IMPORTED_MODULE_4__["getDuration"])(durationInMinutes, `space between`);
...
class StatisticController {
  constructor(userLevelContainer, statisticContainer, moviesModel) {
    ...
    this._interval = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticInterval"].ALL_TIME;
    this._isShowed = false;
  ...
  hide() {
    if (this._isShowed === true) {
      ...
      this._isShowed = false;
      if (this._interval !== _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticInterval"].ALL_TIME) {
        this._onIntervalChange(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticInterval"].ALL_TIME);
      }
    }
  }
  ...
  render(isIntervalChange) {
    if (!isIntervalChange) {
      this._cards = Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["getCardsByFilter"])(this._moviesModel.getAllMovies(), _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].HISTORY);
    ...
    this._statisticComponent = new _components_statistic_js__WEBPACK_IMPORTED_MODULE_7__["default"](this._user, statistic, this._isShowed, this._interval);
    ...
    if (oldStatisticComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._statisticComponent, oldStatisticComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._statisticContainer, this._statisticComponent);
    }
  ...
  renderUserLevel() {
    ...
    this._userLevelComponent = new _components_user_level_js__WEBPACK_IMPORTED_MODULE_6__["default"](this._user);
    if (isToReplace) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._userLevelComponent, oldUserLevelComponent);
    } else if (isToShow) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._userLevelContainer, this._userLevelComponent);
    } else if (isToRemove) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(oldUserLevelComponent);
    }
  }
  ...
  _onIntervalChange(interval) {
    ...
    this._cards = Object(_utils_statistic_js__WEBPACK_IMPORTED_MODULE_3__["getCardsByInterval"])(this._moviesModel.getAllMovies(), this._interval);
...
/*!*********************!*\
  !*** ./src/main.js ***!
  \*********************/
/*! exports provided: statisticDisplayToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "statisticDisplayToggle", function() { return statisticDisplayToggle; });
/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ "./src/api.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_film_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/film-list.js */ "./src/components/film-list.js");
/* harmony import */ var _components_footer_statistics_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/footer-statistics.js */ "./src/components/footer-statistics.js");
/* harmony import */ var _components_loading_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/loading.js */ "./src/components/loading.js");
/* harmony import */ var _models_movies_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/movies.js */ "./src/models/movies.js");
...
/* harmony import */ var _controllers_statistic_controller_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controllers/statistic-controller.js */ "./src/controllers/statistic-controller.js");
/* harmony import */ var _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./controllers/page-controller.js */ "./src/controllers/page-controller.js");
...
const moviesModel = new _models_movies_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

const filmListComponent = new _components_film_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const loadingComponent = new _components_loading_js__WEBPACK_IMPORTED_MODULE_4__["default"]();

const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](pageMain, moviesModel);
const statisticController = new _controllers_statistic_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](pageHeader, pageMain, moviesModel);
const pageController = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](filmListComponent, moviesModel, api);
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(pageMain, filmListComponent);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(filmListComponent.getElement(), loadingComponent);

const renderContent = (cards) => {
  moviesModel.setMovies(cards);
  statisticController.render();
  statisticController.renderUserLevel();
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(loadingComponent);
  pageController.render();
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(footerStatistics, new _components_footer_statistics_js__WEBPACK_IMPORTED_MODULE_3__["default"](cards.length));
};
...
class MoviesModel {
  constructor() {
    this._cards = [];
    this._activeFilterType = _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL_MOVIES;
  ...
  getMovies() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["getCardsByFilter"])(this._cards, this._activeFilterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: HOUR_IN_MINUTES, SPACE, Key, Regular, isEscEvent, swapActiveElements */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HOUR_IN_MINUTES", function() { return HOUR_IN_MINUTES; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swapActiveElements", function() { return swapActiveElements; });
...
const swapActiveElements = (container, target, activeElementClass) => {
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: HIDDEN_CLASS, FilterType, StatisticInterval, StatisticField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticInterval", function() { return StatisticInterval; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticField", function() { return StatisticField; });
...
/***/ "./src/utils/data-process.js":
/*!***********************************!*\
  !*** ./src/utils/data-process.js ***!
  \***********************************/
/*! exports provided: setId, setTwoDigit, getDuration, setActiveItems, matchActiveItems, createMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setId", function() { return setId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setTwoDigit", function() { return setTwoDigit; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDuration", function() { return getDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setActiveItems", function() { return setActiveItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "matchActiveItems", function() { return matchActiveItems; });
...
const setId = (name) => {
  return name.toLowerCase()
    .replace(_common_js__WEBPACK_IMPORTED_MODULE_0__["Regular"].EMPTY_SPACE_IN_EDGES, ``)
    .replace(_common_js__WEBPACK_IMPORTED_MODULE_0__["Regular"].EMPTY_SPACE, _common_js__WEBPACK_IMPORTED_MODULE_0__["Regular"].DASH);
};
...
const getDuration = (minutesAmount, spaceBetween = false) => {
  const hours = Math.floor(minutesAmount / _common_js__WEBPACK_IMPORTED_MODULE_0__["HOUR_IN_MINUTES"])
    ? `${Math.floor(minutesAmount / _common_js__WEBPACK_IMPORTED_MODULE_0__["HOUR_IN_MINUTES"])}${spaceBetween ? ` ` : ``}h`
    : ``;

  const restOfMinutes = minutesAmount % _common_js__WEBPACK_IMPORTED_MODULE_0__["HOUR_IN_MINUTES"]
    ? ` ${minutesAmount % _common_js__WEBPACK_IMPORTED_MODULE_0__["HOUR_IN_MINUTES"]}${spaceBetween ? ` ` : ``}m`
    : ``;
...
const setActiveItems = (itemsList) => itemsList.map((it, i) => it ? i : -1);

const matchActiveItems = (item, itemsToCheck) => itemsToCheck.map((it, i) => item === it ? i : -1);

const createMarkup = (items, renderer, ...activeItems) => items
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getWatchlistCards, getHistoryCards, getFavoritesCards, getCardsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchlistCards", function() { return getWatchlistCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHistoryCards", function() { return getHistoryCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFavoritesCards", function() { return getFavoritesCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCardsByFilter", function() { return getCardsByFilter; });
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");


const getWatchlistCards = (cards) => cards.filter((it) => it[`user_details`][`watchlist`]);

const getHistoryCards = (cards) => cards.filter((it) => it[`user_details`][`already_watched`])
  .sort((first, second) => {
...
const getFavoritesCards = (cards) => cards.filter((it) => it[`user_details`][`favorite`]);

const getCardsByFilter = (cards, filterType) => {
  switch (filterType) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST:
      return getWatchlistCards(cards);

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY:
      return getHistoryCards(cards);

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES:
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, render, replace, remove, createElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/utils/statistic.js":
/*!********************************!*\
  !*** ./src/utils/statistic.js ***!
  \********************************/
/*! exports provided: getCardsByInterval */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCardsByInterval", function() { return getCardsByInterval; });
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
/* harmony import */ var _utils_filter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/filter.js */ "./src/utils/filter.js");
...
const getCardsByInterval = (allCards, interval) => {
  const cards = Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["getCardsByFilter"])(allCards, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY);
  const now = new Date();

  switch (interval) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["StatisticInterval"].TODAY:
      return getWatchedFilms(cards, now, DAY);

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["StatisticInterval"].WEEK:
      return getWatchedFilms(cards, now, WEEK);

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["StatisticInterval"].MONTH:
      return getWatchedFilms(cards, now, MONTH);

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["StatisticInterval"].YEAR:
