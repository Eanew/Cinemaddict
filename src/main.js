...
const createDetailsTopContainerTemplate = () => {
  return (
...
const createDetailsBottomContainerTemplate = () => {
  return (
...
const createDetailsCommentsTemplate = () => {
  return (
...
const createDetailsNewCommentTemplate = () => {
  return (
...
renderHtml(pageMain, createFilmsContainerTemplate());
...
renderHtml(filmListContainer, createShowMoreButtonTemplate(), `afterend`);
renderHtml(pageFooter, createDetailsTemplate(), `afterend`);

const filmDetails = document.querySelector(`.film-details__inner`);

renderHtml(filmDetails, createDetailsTopContainerTemplate());

const detailsTopContainer = filmDetails.querySelector(`.form-details__top-container`);

renderHtml(detailsTopContainer, createFIlmDescriptionTemplate());
renderHtml(detailsTopContainer, createDetailsControlsTemplate());
renderHtml(filmDetails, createDetailsBottomContainerTemplate());

const detailsBottomContainer = filmDetails.querySelector(`.film-details__comments-wrap`);

renderHtml(detailsBottomContainer, createDetailsCommentsTemplate());
renderHtml(detailsBottomContainer, createDetailsNewCommentTemplate());
